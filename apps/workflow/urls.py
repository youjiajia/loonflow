...
from apps.workflow.views import WorkflowView, WorkflowInitView, WorkflowStateView, WorkflowRunScriptView, \
...
urlpatterns = [
    ...
    path('/states', WorkflowStateView.as_view()),
    path('/states/<int:state_id>',
         WorkflowStateDetailView.as_view()),
    ...
    path('/run_scripts/<int:run_script_id>',
         WorkflowRunScriptDetailView.as_view()),
    path('/custom_notices', WorkflowCustomNoticeView.as_view()),
    path('/custom_notices/<int:notice_id>',
         WorkflowCustomNoticeDetailView.as_view()),
